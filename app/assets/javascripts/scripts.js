(function(jQuery) {
		...
		var isMobile = {
            ...
            jQuery('.toggle-1-button').on('click', function(){
                if(jQuery('#toggle-1').css('display') == 'none')
                {
                    ...
                    jQuery('#wrapper-1').animate({left: '0px'}, 500, function(){
            ...
            /* ============== STICKY MENU ============== */
            if(!isMobile.any()&&matchMedia('screen and (min-width : 1200px)').matches){
	...
	jQuery(window).load(function() {
                ...
                /* ============== FIXED FOOTER ============== */
                if(navigator.userAgent.search('MSIE 8.0')>=0){
                    jQuery('.footer-from-sidemenu').css('padding-left', '0px');
                }
                else{
                    var wrap_footer = function(){
                        setTimeout(function(){
                            ...
                            if(jQuery(window).height()>=jQuery('#footer').height()){
                                ...
                                if(jQuery('#wrapper-1').length>0){
                                    jQuery('#wrapper-1').css('height',document.getElementById('wrapper-1').clientHeight + jQuery('#footer').height() + 'px');
                                }
                                if(jQuery('#wrapper-2').length>0){
                                    jQuery('#wrapper-2').css('height',document.getElementById('wrapper-2').clientHeight + jQuery('#footer').height() + 'px');
                                }
                                jQuery('.footer-from-sidemenu').css('padding-left', '300px');
                            }
                            else{
                                jQuery('#footer').css('position','static');
                                jQuery('.footer-from-sidemenu').css('padding-left', '0px');
                    ...
                    jQuery(document).on('resize', wrap_footer);
