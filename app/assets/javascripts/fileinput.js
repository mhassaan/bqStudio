...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        tPreview = '<div class="file-preview {class}">\n' +
            ...
            '    </div>\n' +
            '</div>',
        tIcon = '<span class="fa fa-file-image-o" style="min-width:18px;margin-top:2px;float:left;"></span>',
        ...
        defaultFileTypeSettings = {
            image: function (vType, vName) {
                return (vType !== undefined) ? vType.match('image.*') : vName.match(/\.(gif|png|jpe?g|jpg)$/i);
            },
